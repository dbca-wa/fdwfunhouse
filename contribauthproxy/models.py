...
class ForeignAuthUser(models.Model):
...
@receiver(pre_save, sender=ForeignAuthUser)
def autofieldshim(sender, instance, *args, **kwargs):
    instance.id = ForeignAuthUser.objects.last().id + 1
